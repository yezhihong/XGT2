...
void Merge(const TString& aInputFileName, double* aXbj, double* aR_EX, double* aR_EX_Err, double* aR_MC, int* aN){
    ...
    */
	...
	if(aInputFileName.Contains("QE")){
		c1->Print(Form("./left/XS_%s_%2.0f_QE_%s_L.png", Target.Data(), Theta,Com0.Data()));
		c1->Print(Form("./left/XS_%s_%2.0f_QE_%s_L.pdf", Target.Data(), Theta,Com0.Data()));
	}
	else{
		c1->Print(Form("./left/XS_%s_%2.0f_%s_L.png", Target.Data(), Theta,Com0.Data()));
		c1->Print(Form("./left/XS_%s_%2.0f_%s_L.pdf", Target.Data(), Theta,Com0.Data()));
	}
	/*}}}*/
	/*}}}*/
	...
	*/
	...
	if(aInputFileName.Contains("QE")){
		c2->Print(Form("./left/XS_%s_%2.0f_QE_%s_L.png", Target.Data(), Theta,Com.Data()));
		c2->Print(Form("./left/XS_%s_%2.0f_QE_%s_L.pdf", Target.Data(), Theta,Com.Data()));
	}
	else{
		c2->Print(Form("./left/XS_%s_%2.0f_%s_L.png", Target.Data(), Theta,Com.Data()));
		c2->Print(Form("./left/XS_%s_%2.0f_%s_L.pdf", Target.Data(), Theta,Com.Data()));
	}
	/*}}}*/
	/*}}}*/
...
void Merge25(const TString& Target0, const TString& Target, double* aXbj, double* aR_EX, double* aR_EX_Err, double* aR_MC, int* aN){
	...
	ofstream outfile(Form("./left/XS_5.0_%s_%s_%s_%s_Total_L.dat",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
	ifstream infile1(Form("./left/XS_5.0_%s_%s_%s_%s_L.dat",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
	ifstream infile2(Form("./left/XS_5.1_%s_%s_%s_%s_L.dat",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
...
void E02019(const TString& aInputFileName, const double aTheta,double* aXbj, double* aR_EX, double* aR_EX_Err, int* aN){
	...
	ofstream outfile(Form("./left/E02019_XS_%s_%s_L.dat",Target0.Data(),Target.Data()));
