...
const double SysErr_Boiling_He3 = 0.05; //5%
const double SysErr_Boiling_He4 = 0.05; //5%
const double SysErr_Rho_He3 = 0.05; //5%
const double SysErr_Rho_He4 = 0.05; //5%
...
void Merge(const TString& aInputFileName, double* aXbj, double* aR_EX, double* aR_EX_Err, double* aR_MC, int* aN){
	...
	Double_t nu,Q2,xbj,angle,Ep,Livetime,LT_Sys_Err,Ntg,Ntg_Sys_Err,Ni,Ni_Sys_Err,Nf_EX,Nf_SAMC,Nf_SAMC_Gen,BinCor;
	...
	while ( run_T1L1>>XS>>XS_Stat_Err>>XS_Sys_Err>>XS_MC>>xbj>>angle>>Ep>>nu>>Q2>>BinCor>>Livetime>>LT_Sys_Err>>Ntg>>Ntg_Sys_Err>>Ni>>Ni_Sys_Err>>Nf_EX>>Nf_AL>>Nf_SAMC>>Nf_SAMC_Gen>>Yield_EX>>Y_EX_Stat_Err>>Y_EX_Sys_Err>>Yield_MC>>Y_MC_Stat_Err>>Y_MC_Sys_Err>>Yield_AL>>Y_AL_Stat_Err>>Y_AL_Sys_Err )
	{
	...
	Kin = gGet_Kin_Name(infile_T1L2.Data());
		...
		while ( run_T1L2>>XS>>XS_Stat_Err>>XS_Sys_Err>>XS_MC>>xbj>>angle>>Ep>>nu>>Q2>>BinCor>>Livetime>>LT_Sys_Err>>Ntg>>Ntg_Sys_Err>>Ni>>Ni_Sys_Err>>Nf_EX>>Nf_AL>>Nf_SAMC>>Nf_SAMC_Gen>>Yield_EX>>Y_EX_Stat_Err>>Y_EX_Sys_Err>>Yield_MC>>Y_MC_Stat_Err>>Y_MC_Sys_Err>>Yield_AL>>Y_AL_Stat_Err>>Y_AL_Sys_Err )
		{
			if ( xbj>=Xbj_Min && xbj<=Xbj_Max && angle<180 &&xbj>0.5 &&xbj<=3.00  && XS>0.0 && sqrt(pow(XS_Sys_Err,2)+pow(XS_Stat_Err,2))/XS <0.2)
			{
				Q2 = 4.0 * E0 * Ep * pow(sin(Theta*3.1415926/180./2.0),2);
	...
	Kin = gGet_Kin_Name(infile_T1R1.Data());
		...
		while ( run_T1R1>>XS>>XS_Stat_Err>>XS_Sys_Err>>XS_MC>>xbj>>angle>>Ep>>nu>>Q2>>BinCor>>Livetime>>LT_Sys_Err>>Ntg>>Ntg_Sys_Err>>Ni>>Ni_Sys_Err>>Nf_EX>>Nf_AL>>Nf_SAMC>>Nf_SAMC_Gen>>Yield_EX>>Y_EX_Stat_Err>>Y_EX_Sys_Err>>Yield_MC>>Y_MC_Stat_Err>>Y_MC_Sys_Err>>Yield_AL>>Y_AL_Stat_Err>>Y_AL_Sys_Err )
		{
			if ( xbj>=Xbj_Min && xbj<=Xbj_Max && angle<180 &&xbj>0.5 &&xbj<=3.00  && XS>0.0 && sqrt(pow(XS_Sys_Err,2)+pow(XS_Stat_Err,2))/XS <0.2)
			{
				Q2 = 4.0 * E0 * Ep * pow(sin(Theta*3.1415926/180./2.0),2);
	...
	Kin = gGet_Kin_Name(infile_T1R2.Data());
		...
		while ( run_T1R2>>XS>>XS_Stat_Err>>XS_Sys_Err>>XS_MC>>xbj>>angle>>Ep>>nu>>Q2>>BinCor>>Livetime>>LT_Sys_Err>>Ntg>>Ntg_Sys_Err>>Ni>>Ni_Sys_Err>>Nf_EX>>Nf_AL>>Nf_SAMC>>Nf_SAMC_Gen>>Yield_EX>>Y_EX_Stat_Err>>Y_EX_Sys_Err>>Yield_MC>>Y_MC_Stat_Err>>Y_MC_Sys_Err>>Yield_AL>>Y_AL_Stat_Err>>Y_AL_Sys_Err )
		{
			if ( xbj>=Xbj_Min && xbj<=Xbj_Max && angle<180 &&xbj>0.5  &&xbj<=3.00 && XS>0.0 && sqrt(pow(XS_Sys_Err,2)+pow(XS_Stat_Err,2))/XS <0.2)
			{
				Q2 = 4.0 * E0 * Ep * pow(sin(Theta*3.1415926/180./2.0),2);
...
/*	if(aInputFileName.Contains("QE")){
	...
	comment.ReadLine(run_T2L1);
		while ( run_T2L1>>XS>>XS_Stat_Err>>XS_Sys_Err>>XS_MC>>xbj>>angle>>Ep>>nu>>Q2>>BinCor>>Livetime>>LT_Sys_Err>>Ntg>>Ntg_Sys_Err>>Ni>>Ni_Sys_Err>>Nf_EX>>Nf_AL>>Nf_SAMC>>Nf_SAMC_Gen>>Yield_EX>>Y_EX_Stat_Err>>Y_EX_Sys_Err>>Yield_MC>>Y_MC_Stat_Err>>Y_MC_Sys_Err>>Yield_AL>>Y_AL_Stat_Err>>Y_AL_Sys_Err )
	{
	...
	if(bMore_T2L2){
		...
		while ( run_T2L2>>XS>>XS_Stat_Err>>XS_Sys_Err>>XS_MC>>xbj>>angle>>Ep>>nu>>Q2>>BinCor>>Livetime>>LT_Sys_Err>>Ntg>>Ntg_Sys_Err>>Ni>>Ni_Sys_Err>>Nf_EX>>Nf_AL>>Nf_SAMC>>Nf_SAMC_Gen>>Yield_EX>>Y_EX_Stat_Err>>Y_EX_Sys_Err>>Yield_MC>>Y_MC_Stat_Err>>Y_MC_Sys_Err>>Yield_AL>>Y_AL_Stat_Err>>Y_AL_Sys_Err )
		{
			if ( xbj>=Xbj_Min && xbj<=Xbj_Max && angle<180 &&xbj>0.5  && XS>0.0 && sqrt(pow(XS_Sys_Err,2)+pow(XS_Stat_Err,2))/XS <0.2)
			{
				Q2 = 4.0 * E0 * Ep * pow(sin(Theta*3.1415926/180./2.0),2);
	...
	if(bMore_T2R1){
		...
		while ( run_T2R1>>XS>>XS_Stat_Err>>XS_Sys_Err>>XS_MC>>xbj>>angle>>Ep>>nu>>Q2>>BinCor>>Livetime>>LT_Sys_Err>>Ntg>>Ntg_Sys_Err>>Ni>>Ni_Sys_Err>>Nf_EX>>Nf_AL>>Nf_SAMC>>Nf_SAMC_Gen>>Yield_EX>>Y_EX_Stat_Err>>Y_EX_Sys_Err>>Yield_MC>>Y_MC_Stat_Err>>Y_MC_Sys_Err>>Yield_AL>>Y_AL_Stat_Err>>Y_AL_Sys_Err )
		{
			if ( xbj>=Xbj_Min && xbj<=Xbj_Max && angle<180 &&xbj>0.5  && XS>0.0 && sqrt(pow(XS_Sys_Err,2)+pow(XS_Stat_Err,2))/XS <0.2)
			{
				Q2 = 4.0 * E0 * Ep * pow(sin(Theta*3.1415926/180./2.0),2);
	...
	if(bMore_T2R2){
		...
		while ( run_T2R2>>XS>>XS_Stat_Err>>XS_Sys_Err>>XS_MC>>xbj>>angle>>Ep>>nu>>Q2>>BinCor>>Livetime>>LT_Sys_Err>>Ntg>>Ntg_Sys_Err>>Ni>>Ni_Sys_Err>>Nf_EX>>Nf_AL>>Nf_SAMC>>Nf_SAMC_Gen>>Yield_EX>>Y_EX_Stat_Err>>Y_EX_Sys_Err>>Yield_MC>>Y_MC_Stat_Err>>Y_MC_Sys_Err>>Yield_AL>>Y_AL_Stat_Err>>Y_AL_Sys_Err )
		{
			if ( xbj>=Xbj_Min && xbj<=Xbj_Max && angle<180 &&xbj>0.5  && XS>0.0 && sqrt(pow(XS_Sys_Err,2)+pow(XS_Stat_Err,2))/XS <0.2)
			{
				Q2 = 4.0 * E0 * Ep * pow(sin(Theta*3.1415926/180./2.0),2);
