...
int main()
{
	...
	c4->cd(); l1->Draw();
	if(bMC){
		c3->Print(Form("./right/%s_%s_XS_Ratio_MC_%s_%s_L.png",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
		c3->Print(Form("./right/%s_%s_XS_Ratio_MC_%s_%s_L.pdf",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
	}
	else{
		c3->Print(Form("./right/%s_%s_XS_Ratio_%s_%s_L.png",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
		c3->Print(Form("./right/%s_%s_XS_Ratio_%s_%s_L.pdf",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
	}
	if(bMC){
		c4->Print(Form("./right/%s_%s_XS_Ratio_MC_%s_%s_Zoom_L.png",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
		c4->Print(Form("./right/%s_%s_XS_Ratio_MC_%s_%s_Zoom_L.pdf",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
	}
	else{
		c4->Print(Form("./right/%s_%s_XS_Ratio_%s_%s_Zoom_L.png",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
		c4->Print(Form("./right/%s_%s_XS_Ratio_%s_%s_Zoom_L.pdf",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
	}
...
void Merge(const TString& aInputFileName, double* aXbj, double* aR_EX, double* aR_EX_Err, double* aR_MC, int* aN){
	...
	for(int i=0;i<Count_T1L1;i++){
		...
		XS_StatErr_Sum_T1L = pow(XS_StatErr_T1L1[i]/XS_T1L1[i],2);
		...
		if(bMore_T1L2){
			for(int j=0;j<Count_T1L2;j++){
				...
				if(abs(Xbj_T1L1[i]-Xbj_T1L2[j])< 0.0001){
					...
					XS_StatErr_Sum_T1L +=	pow(XS_StatErr_T1L2[j]/XS_T1L2[j],2);
			...
			XS_StatErr_T1L[i] = XS_T1L[i] * sqrt(XS_StatErr_Sum_T1L) / fSum_T1L; 
		...
		if(bMore_T1R1){
			for(int i=0;i<Count_T1R1;i++){
				...
				XS_StatErr_Sum_T1R = pow(XS_StatErr_T1R1[i]/XS_T1R1[i],2);
				...
				if(bMore_T1R2){
					for(int j=0;j<Count_T1R2;j++){
						...
						if(abs(Xbj_T1R1[i]-Xbj_T1R2[j])< 0.0001){
							...
							XS_StatErr_Sum_T1R +=	pow(XS_StatErr_T1R2[j]/XS_T1R2[j],2);
					...
					XS_StatErr_T1R[i] = XS_T1R[i] * sqrt(XS_StatErr_Sum_T1R) / fSum_T1R; 
			...
			if(bMore_T1R1){
				...
				if(aInputFileName.Contains("QE")){
					c1->Print(Form("./right/XS_%s_%2.0f_QE_L_%s.png", Target.Data(), Theta,Com0.Data()));
					c1->Print(Form("./right/XS_%s_%2.0f_QE_L_%s.pdf", Target.Data(), Theta,Com0.Data()));
				}
				else{
					c1->Print(Form("./right/XS_%s_%2.0f_%s_L.png", Target.Data(), Theta,Com0.Data()));
					c1->Print(Form("./right/XS_%s_%2.0f_%s_L.pdf", Target.Data(), Theta,Com0.Data()));
				}
				/*}}}*/
				/*}}}*/
				...
				for(int i=0;i<Count_T2L1;i++){
					...
					XS_StatErr_Sum_T2L = pow(XS_StatErr_T2L1[i]/XS_T2L1[i],2);
					...
					if(bMore_T2L2){
						for(int j=0;j<Count_T2L2;j++){
							...
							if(abs(Xbj_T2L1[i]-Xbj_T2L2[j])< 0.0001){
								...
								XS_StatErr_Sum_T2L +=	pow(XS_StatErr_T2L2[j]/XS_T2L2[j],2);
						...
						XS_StatErr_T2L[i] = XS_T2L[i] * sqrt(XS_StatErr_Sum_T2L) / fSum_T2L; 
					...
					if(bMore_T2R1){
						for(int i=0;i<Count_T2R1;i++){
							...
							XS_StatErr_Sum_T2R = pow(XS_StatErr_T2R1[i]/XS_T2R1[i],2);
							...
							if(bMore_T2R2){
								for(int j=0;j<Count_T2R2;j++){
									...
									if(abs(Xbj_T2R1[i]-Xbj_T2R2[j])< 0.0001){
										...
										XS_StatErr_Sum_T2R +=	pow(XS_SystErr_T2R2[j]/XS_T2R2[j],2);
								...
								XS_StatErr_T2R[i] = XS_T2R[i] * sqrt(XS_StatErr_Sum_T2R) / fSum_T2R; 
						...
						if(bMore_T2R1){
							...
							if(aInputFileName.Contains("QE")){
								c2->Print(Form("./right/XS_%s_%2.0f_QE_L_%s.png", Target.Data(), Theta,Com.Data()));
								c2->Print(Form("./right/XS_%s_%2.0f_QE_L_%s.pdf", Target.Data(), Theta,Com.Data()));
							}
							else{
								c2->Print(Form("./right/XS_%s_%2.0f_%s_L.png", Target.Data(), Theta,Com.Data()));
								c2->Print(Form("./right/XS_%s_%2.0f_%s_L.pdf", Target.Data(), Theta,Com.Data()));
							}
							/*}}}*/
							/*}}}*/
