...
/*}}}*/
	...
	TLegend *l1 = new TLegend(lx_min,0.57,lx_max, 0.94,"");
	...
	TLegend *l11 = new TLegend(lx_min,0.85,lx_max, 0.94,"");
    ...
    TLegend *l12 = new TLegend(lx_min,0.85,lx_max, 0.94,"");
...
/*}}}*/
    ...
    if(Target=="He3"){
		...
		exNF->SetMarkerStyle(20);
		exNF->SetMarkerSize(1.3);
		exNF->SetMarkerColor(33);
		exNF->SetLineColor(33);
    ...
    if(Target0=="C12"&&Target=="He4" && 0){
		exNF_He4->SetMarkerStyle(20);
		exNF_He4->SetMarkerSize(1.3);
		exNF_He4->SetMarkerColor(37);
		exNF_He4->SetLineColor(37);
    ...
    if(Target0=="He4"&&Target=="He3"){
		...
		exCS->SetMarkerSize(1.3);
		exCS->SetMarkerColor(42);
		exCS->SetLineColor(42);
...
void Merge(const TString& aInputFileName, double* aXbj, double* aR_EX, double* aR_EX_Err, double* aR_MC, int* aN){
	...
	xs_T1L1->Load_Table(Target.Data(),KinName_T1L1.Data());
        ...
        ofstream out_err(Form("./both/err_%s_%s_%s_%s_%s.dat",Kin0.Data(),Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
