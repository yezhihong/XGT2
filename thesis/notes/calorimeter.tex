...
%\clearpage
\begin{figure}[htb]
\centerline{\psfig{figure=figures/ShowerBoth.eps,width=14cm,,angle=0,clip=}}
...
%\clearpage
\begin{figure}[htb]
\centerline{\psfig{figure=figures/R_Sh_Ps_Before.eps,width=12cm,scale=0.5,angle=0,clip=}}
...
%\clearpage
\begin{figure}[htb]
\centerline{\psfig{figure=figures/R_Sh_Ps_After.eps,width=12cm,scale=0.5,angle=0,clip=}}
...
%\clearpage
\begin{figure}[htb]
\centerline{\psfig{figure=figures/R_Calo_EP.eps,width=12cm,scale=0.5,angle=0,clip=}}
...
%\clearpage
\begin{figure}[htb]
\centerline{\psfig{figure=figures/R_Calo_Stability.eps,width=12cm,scale=0.45,angle=0,clip=}}
...
%\clearpage
\begin{figure}[htb]
\centerline{\psfig{figure=figures/R_Calo_Resol.eps,width=12cm,scale=0.45,angle=0,clip=}}
\caption[Calibrated E/P for different run numbers]{\footnotesize{Calibrated E/P for different run numbers}
\label{ep_resol}}
\end{figure}
...
%\clearpage
\begin{figure}[htb]
\centerline{\psfig{figure=figures/L_prl1_adj2_0.eps,width=12cm,scale=0.8,angle=0,clip=}}
...
%\clearpage
\begin{figure}[htb]
\centerline{\psfig{figure=figures/L_PRL_Before.eps,width=12cm,scale=0.5,angle=0,clip=}}
...
%\clearpage
\begin{figure}[htb]
\centerline{\psfig{figure=figures/L_PRL_After.eps,width=12cm,scale=0.5,angle=0,clip=}}
...
%\clearpage
\begin{figure}[htb]
\centerline{\psfig{figure=figures/L_Calo_EP.eps,width=12cm,scale=0.5,angle=0,clip=}}
\caption[After calibration]{\footnotesize{After calibration}
\label{prlep_mean}}
\end{figure}
...
%\clearpage
\begin{figure}[htb]
\centerline{\psfig{figure=figures/L_Calo_Stability.eps,width=12cm,scale=0.5,angle=0,clip=}}
\caption[Calibrated E/P for different run numbers]{\footnotesize{Calibrated E/P for different run numbers}
...
%\clearpage
\begin{figure}[htb]
\centerline{\psfig{figure=figures/L_Calo_Resol.eps,width=12cm,scale=0.5,angle=0,clip=}}
\caption[Calibrated E/P for different run numbers]{\footnotesize{Calibrated E/P for different run numbers}
\label{prlp_resol}}
\end{figure}
